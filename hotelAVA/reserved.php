        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
                ...
                <h5 class="card-title">STANDART ROOM</h5>
                    <div class="room-info">
                        <div>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="room-dot" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
                        ...
                        <div class="price">
                            <svg xmlns="http://www.w3.org/2000/svg" class="svg-about" fill="currentColor" class="bi bi-cash-coin" viewBox="0 0 16 16">
            ...
            <div class="col">
              <div class="card h-100">
                ...
                <div class="card-body">
                  <h5 class="card-title">LUX ROOM</h5>
                  <div class="room-info">
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" class="room-dot" fill="currentColor" class="bi bi-dot" viewBox="0 0 16 16">
                            <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3z"/>
